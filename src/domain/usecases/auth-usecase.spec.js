...
const makeUpdateAccesTokenRepository = () => {
  class UpdateAccesTokenRepositorySpy {
    async update (userId, accessToken) {
      this.userId = userId
      this.accessToken = accessToken
    }
  }
  return new UpdateAccesTokenRepositorySpy()
}
...
describe('Auth UseCase', () => {
  ...
  test('Should call Encryper with correct values', async () => {
  ...
  test('Should throw if dependencies throws', async () => {
    ...
    const suts = [].concat(
      ...
      new AuthUseCase({
        ...
        encrypter,
        tokenGenerator,
        updateAccessTokenRepository: makeUpdateAccesTokenRepositoryWithError()
      })
    )
    for (const sut of suts) {
      const promise = sut.auth('any_email@mail.com', 'any_password')
